...
## Future work
To improve accuracy of this experiments we can take a look to the metrics and check which of the features are more important, remove the less important and collect other pieces of data that may improve the accuracy of the models.
